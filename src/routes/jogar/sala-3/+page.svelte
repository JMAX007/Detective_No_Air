<script>
  ...
  function iniciarSala() {
    texto = "Cheguei vamos ver o que tem nessas salas.";
    dialogoAberto = true;
  }
  ...
  function interagir(objeto) {
    ...
    // Porta do Terraço (Trancada)
    if (objeto === "porta-terraco") {
      dialogoAberto = true;
      texto = "Droga a porta do terraço está trancada, preciso encontrar a chave ou algo que sirva para abrir nem que eu arrombe essa porta";
      return;
    }

    // Porta de Serviços (Aberta - Te leva para a próxima área)
...
<style>
  ...
  /* ========================================================== */
  /* HOTSPOTS VISÍVEIS PARA AJUSTE (Fundo vermelho/Borda amarela)*/
  /* ========================================================== */
  .hotspot {
  position: absolute;
...
.hotspot:hover {
  ...
  /* Posições base (Ajuste esses valores top, left, width, height) */
...
<div class="tela">
  <div class="cenario">
    ...
    <!-- COLOQUE A IMAGEM DO TOPO DO PRÉDIO AQUI -->
